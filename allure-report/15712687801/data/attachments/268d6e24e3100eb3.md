...
- Name: @game >> Taboo > Lobby > Click on Game > Test Launch game > Play Power of Merlin Megaways 
...
Call log:
  - waiting for getByRole('button', { name: 'Play Power of Merlin Megaways' }).first()
    ...
    at /home/runner/work/TabooAutomation/TabooAutomation/__tests__/game/gameTests.spec.js:54:32
```
