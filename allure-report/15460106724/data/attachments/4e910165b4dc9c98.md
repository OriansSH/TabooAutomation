...
Error: expect.toHaveText: Error: strict mode violation: locator('.ple-error-message') resolved to 2 elements:
    ...
    2) <p id=":r0:-form-item-message" class="ple-text-[0.8rem] ple-font-medium ple-text-destructive ple-error-message">…</p> aka getByText('Required')
...
Call log:
  ...
  - waiting for locator('.ple-error-message')
    ...
    at /home/runner/work/TabooAutomation/TabooAutomation/__tests__/purchase/purchaseTests.spec.js:71:24
```
