...
Call log:
  ...
  - waiting for locator('pce-log-in').locator('button[type="submit"]')
    9 × locator resolved to <button type="submit" id=":r2:-form-item" aria-invalid="false" data-testid="login-button" aria-describedby=":r2:-form-item-description" class="ple-inline-flex ple-items-center ple-justify-center ple-gap-2 ple-whitespace-nowrap ple-rounded-md ple-text-sm ple-font-medium ple-transition-colors focus-visible:ple-outline-none focus-visible:ple-ring-1 focus-visible:ple-ring-ring disabled:ple-pointer-events-none disabled:ple-opacity-50 [&_svg]:ple-pointer-events-none [&_svg]:ple-size-4 [&_svg]:ple-shrink-0 p…>Login</button>
